...
class User:
    ...
    data_nascimento: Optional[date] = None  # Sincronizado para 'date' para evitar ValidationError no Pydantic
...
def dict_to_orcamento(data: dict) -> Optional[Orcamento]:
    """Converte dicionário do banco para entidade Orcamento."""
    if not data:
        return None
    return Orcamento(**data)

def dict_to_orcamento_peca(data: dict) -> Optional[OrcamentoPeca]:
...
def dict_to_orcamento_servico(data: dict) -> Optional[OrcamentoServico]:
...
def endereco_to_dict(endereco: Endereco) -> Optional[dict]:
...
def marca_to_dict(marca: Marca) -> Optional[dict]:
...
def modelo_to_dict(modelo: Modelo) -> Optional[dict]:
...
def veiculo_to_dict(veiculo: Veiculo) -> Optional[dict]:
...
def servico_to_dict(servico: Servico) -> Optional[dict]:
...
def produto_to_dict(produto: Produto) -> Optional[dict]:
...
def pedido_to_dict(pedido: Pedido) -> Optional[dict]:
...
def pedido_produto_to_dict(pedido_produto: PedidoProduto) -> Optional[dict]:
...
def peca_to_dict(peca: Peca) -> Optional[dict]:
...
def agendamento_to_dict(agendamento: Agendamento) -> Optional[dict]:
...
def orcamento_to_dict(orcamento: Orcamento) -> Optional[dict]:
...
def orcamento_peca_to_dict(orcamento_peca: OrcamentoPeca) -> Optional[dict]:
...
def orcamento_servico_to_dict(orcamento_servico: OrcamentoServico) -> Optional[dict]:
...
def ordem_servico_to_dict(ordem_servico: OrdemServico) -> Optional[dict]:
...
def ordem_servico_peca_to_dict(ordem_servico_peca: OrdemServicoPeca) -> Optional[dict]:
...
def ordem_servico_servico_to_dict(ordem_servico_servico: OrdemServicoServico) -> Optional[dict]:
...
def mecanico_to_dict(mecanico: Mecanico) -> Optional[dict]:
...
def movimentacao_estoque_to_dict(movimentacao: MovimentacaoEstoque) -> Optional[dict]:
...
def pagamento_to_dict(pagamento: Pagamento) -> Optional[dict]:
...
def movimentacao_financeira_to_dict(movimentacao: MovimentacaoFinanceira) -> Optional[dict]:
...
def dict_to_orcamento_peca_response(data: dict) -> Optional[OrcamentoPecaResponse]:
...
def dict_to_orcamento_servico_response(data: dict) -> Optional[OrcamentoServicoResponse]:
...
def dict_to_ordem_servico_peca_response(data: dict) -> Optional[OrdemServicoPecaResponse]:
...
def dict_to_ordem_servico_servico_response(data: dict) -> Optional[OrdemServicoServicoResponse]:
