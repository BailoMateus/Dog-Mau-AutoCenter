...
def gerar_relatorio_faturamento(data: RelatorioPeriodo):
    ...
    logger.info("POST /relatorios/faturamento periodo=%s a %s", data.data_abertura, data.data_fim)
...
def gerar_relatorio_servicos_realizados(data: RelatorioPeriodo):
    ...
    logger.info("POST /relatorios/servicos-realizados periodo=%s a %s", data.data_abertura, data.data_fim)
...
def gerar_relatorio_ordens_servico(data: RelatorioPeriodo):
    ...
    logger.info("POST /relatorios/ordens-servico periodo=%s a %s", data.data_abertura, data.data_fim)
...
def gerar_relatorio_financeiro_periodo(data: RelatorioPeriodo):
    ...
    logger.info("POST /relatorios/financeiro-periodo periodo=%s a %s", data.data_abertura, data.data_fim)
...
def gerar_relatorio_completo(data: RelatorioPeriodo):
    ...
    logger.info("POST /relatorios/completo periodo=%s a %s", data.data_abertura, data.data_fim)
